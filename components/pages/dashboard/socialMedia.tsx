    ...
    return (
        <div className='d-flex flex-column justify-content-center align-items-center mt-3' style={{ background: '#2d353e', padding: '40px 0px', width: '100%' }}>
            ...
            <div className='d-flex flex-md-row justify-content-between gapping align-items-center'>
                <a href="https://www.linkedin.com/in/nestor-victorino-099a15174/" className='text-white' target={'_blank'}>
                ...
                <a href="https://github.com/Nestorvictorino" className='text-white' target={'_blank'}>
                    <span className='d-flex flex-column align-items-center justify-content-center' style={{ fontSize: '1rem' }}>
                        <FontAwesomeIcon icon={faGithub} style={{width:'5rem'}}/>
                        {/* <p>GitHub</p> */}
                    </span>
                </a>
                <a href="https://www.instagram.com/nestorvictorino/" className='text-white' target={'_blank'}>
                    <span className='d-flex flex-column align-items-center justify-content-center' style={{ fontSize: '1rem' }}>
